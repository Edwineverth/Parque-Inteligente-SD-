"""
Django settings for PARQUEIOT project.
...
SECRET_KEY = '#**4trv7!1b0eq($w48#%^io1ll9c_=ij=2t-%9c3y!xb-3o31'
...
ROOT_URLCONF = 'PARQUEIOT.urls'

WSGI_APPLICATION = 'PARQUEIOT.wsgi.application'
